          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-6 hover:shadow-lg hover:-translate-y-1 hover:scale-[1.02] transition-all duration-200 ease-out">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-white mt-2">{summaryData.totalClients}</p>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-6 hover:shadow-lg hover:-translate-y-1 hover:scale-[1.02] transition-all duration-200 ease-out">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-white mt-2">{summaryData.pendingTasks}</p>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-6 hover:shadow-lg hover:-translate-y-1 hover:scale-[1.02] transition-all duration-200 ease-out">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-white mt-2">+{summaryData.engagement}%</p>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-6">
            ...
            <div className="space-y-3">
              {[1, 2, 3, 4].map((item) => (
                <div
                  key={item}
                  className="flex items-start gap-3 p-3 bg-slate-800/50 border border-slate-700 rounded-lg hover:bg-slate-800 transition-all duration-200"
                >
