      ...
      <div className="min-h-screen pb-12">
        ...
        <div className="saas-container py-8 animate-pulse space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="card p-5 h-32 bg-gray-100/50 flex flex-col justify-between border border-gray-100 shadow-sm">
          ...
          {/* Chart & Platform Breakdown Skeletons */}
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            <div className="xl:col-span-2 h-[450px] card p-6 bg-gray-100/50 flex flex-col justify-between border border-gray-100 shadow-sm">
              <div className="h-6 bg-gray-200 rounded w-1/4 mb-4"></div>
              <div className="flex-1 bg-gray-200 rounded-2xl"></div>
            </div>
            <div className="h-[450px] card p-6 bg-gray-100/50 flex flex-col justify-between border border-gray-100 shadow-sm">
